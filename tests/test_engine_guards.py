...
from onlyichu.ichimoku import IchimokuState
...
def make_engine(tmp_path, cap):
    ...
    def fake_enter(pid, ik, sym, qty, direction, price_hint, underlying_spot=None, strike=None, lot_size=None, candle_time=None):
        calls["n"] += 1
